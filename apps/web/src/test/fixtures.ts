...
export const fixtures = {
  ...
  systemStatus: { backend_status: "ready" as const, worker_status: "current" as const, worker_heartbeat_at: "2026-08-09T01:05:00Z", active_queue: 0, review_backlog: 1, image_errors: 0, ingestion_limits: { max_archive_files: 1_000, max_upload_bytes: 25 * 1024 * 1024 } },
};
